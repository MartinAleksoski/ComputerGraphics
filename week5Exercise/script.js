...
const endColor = new THREE.Color(0x800080);

const interpolatedColor = startColor.clone().lerp(endColor,0.5);
const interpolatedMaterail = new THREE.MeshBasicMaterial({color:interpolatedColor});
const interpolatedCube = new THREE.Mesh (new THREE.BoxGeometry(1,1,1), interpolatedMaterail);
